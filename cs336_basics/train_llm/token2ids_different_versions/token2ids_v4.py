...
def main():
    ...
    OUTPUT_DATA_REPO = ASSIGNMENT_REPO / "token_to_id_outputs_tinystory"
    OUTPUT_DATA_REPO.mkdir(parents=True, exist_ok=True)

    # OWT_VALID_NPY_PATH = ASSIGNMENT_REPO / "cs336_basics/train_llm/scripts/tinystory_valid_chunk_token_counts.npy"
    # valid_token_arr_path = OUTPUT_DATA_REPO / "valid_ids.bin"
    # N_valid_num = 5_461_161
    ...
    OWT_TRAIN_NPY_PATH = ASSIGNMENT_REPO / "cs336_basics/train_llm/scripts/tinystory_train_chunk_token_counts.npy"
    train_token_arr_path = OUTPUT_DATA_REPO / "train_ids.bin"
    N_train_num = 540_796_644
